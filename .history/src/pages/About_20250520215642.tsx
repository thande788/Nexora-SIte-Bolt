import { ExternalLink, BarChart3, Users, Lock, ArrowRight } from 'lucide-react';
  ...
  const teamMembers = [
    {
      ...
      image: '/images/thande.jpg',
      bio: 'With over 8 years in strategy consulting and digital transformation, Amir founded Nexora to bridge the gap between AI innovation and practical business applications in East Africa.'
    },
    {
      name: 'Grace Muthoni',
    ...
    },
    {
      ...
      image: '', // Use empty string to indicate placeholder
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              <div>
                <p className="text-gray-700 dark:text-gray-300 mb-6">
                  Founded in 2024, Nexora Consulting emerged from a vision to address a significant gap in the East African business landscape: the integration of advanced AI solutions with traditional business advisory services.
                </p>
                <p className="text-gray-700 dark:text-gray-300 mb-6">
                ...
                <div className="md:grid md:grid-cols-2 md:gap-8 items-center relative">
                  <div className="md:text-right fade-in-up">
                    <div className="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-xl shadow-soft mb-4 md:mb-0 relative border border-gray-100 dark:border-gray-700">
                      ...
                      <span className="text-sm text-primary-600 dark:text-primary-400 font-medium mb-2 block">2024</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
            {teamMembers.map((member, index) => (
              <div key={index} className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-soft border border-gray-100 dark:border-gray-700 group">
                <div className="relative h-72 overflow-hidden flex items-center justify-center bg-gray-100 dark:bg-gray-700">
                  {member.name === 'Amir Thande' ? (
                    <img 
                      src={member.image} 
                      alt={member.name} 
                    ...
                    <div className="flex flex-col items-center justify-center w-full h-full">
                      <div className="w-24 h-24 rounded-full bg-gray-300 dark:bg-gray-600 flex items-center justify-center mx-auto mb-4">
                        <span className="text-3xl font-bold text-gray-500 dark:text-gray-200">
