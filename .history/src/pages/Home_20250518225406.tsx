solve import { ArrowRight, PieChart, BrainCircuit, Clock, Database, BarChart, Shield, Users } from 'lucide-react'; // Removed LineChart
      ...
      <section className="py-20 bg-primary-900 dark:bg-gray-800 relative">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-12">
            <TestimonialCard
              quote="Nexora's AI-powered financial tools have completely transformed how we handle our accounting and forecasting. We've reduced manual processes by 70% and gained much better visibility into our financial health."
              name="Sarah Mwangi"
              position="CFO"
            ...
            />
            <TestimonialCard
              quote="The operations consulting team at Nexora helped us identify inefficiencies we didn't even know existed. Their recommendations led to a 22% increase in productivity across our manufacturing facilities."
              name="James Ochieng"
              position="Operations Director"
              company="EastAfrica Manufacturing Ltd"
              image="https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&w=600"
            />
            <TestimonialCard
              quote="As a fast-growing startup, we needed HR systems that could scale with us. Nexora's talent analytics platform has been a game-changer for our recruitment and employee development strategies."
              name="Grace Njeri"
              position="Head of People"
              company="Savannah Innovations"
