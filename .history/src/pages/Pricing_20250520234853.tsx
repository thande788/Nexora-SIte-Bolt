...
interface CartTableProps {
  cart: PlanItem[];
  setCart: React.Dispatch<React.SetStateAction<PlanItem[]>>;
  clearCart: () => void;
  removeFromCart: (name: string) => void;
  bundleApplied: BundleApplied | null;
...
const Pricing: React.FC = () => {
  ...
  const applyBundle = (bundleName: string, bundlePrice: number, replaceItems: PlanItem[]) => {
