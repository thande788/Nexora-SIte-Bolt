              ...
              {services.map((service) =>
                service.plans.map((plan, idx) => (
                  <div
                    key={plan.name}
                    className={clsx(
                      'relative bg-white dark:bg-gray-800 rounded-xl shadow-soft border border-gray-100 dark:border-gray-700 flex flex-col',
                  ...
                  >
                    ...
                    {plan.badge && (
                      <div className={clsx(
                        ...
                        <div
                          className={clsx(
                            "absolute right-[-40px] top-4 w-40 text-center text-xs font-bold text-white py-1 rotate-45 shadow-lg",
