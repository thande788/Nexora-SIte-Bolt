...
import { ChevronDown, Check, BadgePercent, Star, Users, PieChart, BarChart3, Shield, BrainCircuit, Layers, Zap } from 'lucide-react';
              ...
              {services.map((service) =>
                service.plans.map((plan, idx) => (
                  <div
                    key={plan.name}
                    className={clsx(
                      'bg-white dark:bg-gray-800 rounded-xl shadow-soft border border-gray-100 dark:border-gray-700 flex flex-col',
                  ...
                  >
                    <div className="flex items-center justify-between p-6 pb-0">
                      <div className="flex items-center gap-2">
                        ...
                        {plan.badge && (
                          <span className={clsx(
                            "ml-3 px-2 py-1 rounded-full text-xs font-bold whitespace-nowrap",
