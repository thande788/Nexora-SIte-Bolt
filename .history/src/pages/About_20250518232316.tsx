  ...
  const teamMembers = [
    {
      ...
      image: '/images',
      bio: 'With over 15 years in strategy consulting and digital transformation, Amir founded Nexora to bridge the gap between AI innovation and practical business applications in East Africa.'
    },
    {
      name: 'Grace Muthoni',
