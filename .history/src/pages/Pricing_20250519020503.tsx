    ...
    <div className="bg-white dark:bg-gray-900">
      ...
      {showCart && (
        <div className={clsx(
          ...
          <div className="bg-white dark:bg-gray-900 border border-primary-200 dark:border-gray-700 rounded-xl shadow-xl p-4 relative animate-fade-in">
            <button
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-bold text-lg text-primary-800 dark:text-white">Your Plan</h3>
            </div>
            {cart.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {services.map((service, sIdx) => (
                <div
                  ...
                  className={clsx(
                    "p-2 rounded-2xl mb-4",
                    threadColors[sIdx % threadColors.length],
                    "border-2"
                  )}
                >
                  <div className="flex items-center gap-2 mb-2">
                    {service.icon}
                    <span className="font-bold text-primary-900 dark:text-white">{service.category}</span>
                  </div>
                  {service.plans.map((plan, idx) => (
                    ...
                    >
                      ...
                      {plan.tier && (
                        <span className={clsx(
                          "absolute top-3 left-3 px-2 py-0.5 rounded-full text-xs font-bold",
                          plan.tier === 'Basic'
