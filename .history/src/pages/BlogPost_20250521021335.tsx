...
const BlogPost = () => {
  ...
  // Fallbacks for author info
  const author = post.author || "Nexora Team";
  const authorImage = post.authorImage;
  const authorPosition = post.authorPosition || "";
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
              ...
              <aside className="md:col-span-3 order-2 md:order-1">
                <div className="sticky top-32">
                  {/* Author Info */}
                  {(authorImage || author || authorPosition) && (
                    <div className="mb-8">
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          <div className="font-medium text-primary-900 dark:text-white">{author}</div>
                          {authorPosition && (
                            <div className="text-sm text-gray-600 dark:text-gray-400">{authorPosition}</div>
                          )}
                        </div>
                      </div>
                    </div>
