              ...
              <div className="md:grid md:grid-cols-2 md:gap-16 items-center">
                <div className="md:text-right fade-in-up">
                  <div className="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-xl shadow-soft relative">
                    <div className="absolute top-1/2 -translate-y-1/2 -right-4 h-8 w-8 bg-primary-600 rounded-full text-white items-center justify-center font-bold z-10 hidden md:flex">1</div>
