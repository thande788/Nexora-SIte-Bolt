...
import {
  ...
  addOns,
  bundles,
} from "../types/plans"; // Adjust the import path as necessary
import CartTable from "../";

// Types
type PlanType = "service" | "bundle" | "add-on";
interface PlanItem {
  name: string;
  price: number;
  type: PlanType;
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 grid md:grid-cols-3 gap-4">
      <div className="md:col-span-2 space-y-4">
        ...
        {[...baseServices, ...premiumServices].map((service: PlanItem) => (
          <div
            key={service.name}
