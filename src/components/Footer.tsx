        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              <img
                ...
                alt="Nexora Logo"
                className="h-10 w-10 rounded-lg bg-white mr-2 object-contain"
              />
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/careers" className="text-gray-300 hover:text-accent-400 transition-colors flex items-center">
