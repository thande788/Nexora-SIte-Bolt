  ...
  return (
    ...
    >
      ...
      <div className="p-6 md:px-8 pt-0 md:pb-8">
        <Link
          to="/contact"
          className={`w-full block text-center py-3 px-4 rounded-lg text-white font-medium transition-all focus:outline-none focus:ring-4 ${colorClasses[color].button}`}
        >
          {ctaText}
        </Link>
      </div>
